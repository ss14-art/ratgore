            ...
            HasComp<MobStateComponent>(args.Target))
        {
            ...
            Verb hardElectrocute = new()
            {
                ...
                Act = () =>
                {
                    ...
                    int damageToDeal;
                    if (!_mobThresholdSystem.TryGetThresholdForState(
                        args.Target,
                        MobState.Critical,
        ...
        if (TryComp<BodyComponent>(args.Target, out var body))
        {
            ...
            Verb handsRemoval = new()
            {
                ...
                Act = () =>
                {
                    ...
                    foreach (var organ in organs.Where(it =>
                        it.Comp.Category is { } category && parts.Contains(category)))
                    {
        ...
        if (TryComp<InventoryComponent>(args.Target, out var inventory))
        {
            ...
            Verb killSign = new()
            {
                ...
                Act = () =>
                {
                    ...
                    comp.HideFromOwner =
                        false; // We set it to false anyway, in case the hidden smite was used beforehand.
